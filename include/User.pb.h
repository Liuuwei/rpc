...
class RegisterRequeset;
class RegisterRequesetDefaultTypeInternal;
extern RegisterRequesetDefaultTypeInternal _RegisterRequeset_default_instance_;
...
template<> ::fixbug::RegisterRequeset* Arena::CreateMaybeMessage<::fixbug::RegisterRequeset>(Arena*);
...
class RegisterRequeset PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:fixbug.RegisterRequeset) */ {
 public:
  inline RegisterRequeset() : RegisterRequeset(nullptr) {};
  virtual ~RegisterRequeset();

  RegisterRequeset(const RegisterRequeset& from);
  RegisterRequeset(RegisterRequeset&& from) noexcept
    : RegisterRequeset() {
    *this = ::std::move(from);
  }

  inline RegisterRequeset& operator=(const RegisterRequeset& from) {
    CopyFrom(from);
    return *this;
  }
  inline RegisterRequeset& operator=(RegisterRequeset&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const RegisterRequeset& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const RegisterRequeset* internal_default_instance() {
    return reinterpret_cast<const RegisterRequeset*>(
               &_RegisterRequeset_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    3;

  friend void swap(RegisterRequeset& a, RegisterRequeset& b) {
    a.Swap(&b);
  }
  inline void Swap(RegisterRequeset* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(RegisterRequeset* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline RegisterRequeset* New() const final {
    return CreateMaybeMessage<RegisterRequeset>(nullptr);
  }

  RegisterRequeset* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<RegisterRequeset>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const RegisterRequeset& from);
  void MergeFrom(const RegisterRequeset& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(RegisterRequeset* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "fixbug.RegisterRequeset";
  }
  protected:
  explicit RegisterRequeset(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:fixbug.RegisterRequeset)
 private:
  class _Internal;
...
class UserServiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void Regis(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       const ::fixbug::RegisterRequeset* request,
...
// uint32 id = 1;
inline void RegisterRequeset::clear_id() {
  id_ = 0u;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegisterRequeset::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 RegisterRequeset::id() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterRequeset.id)
  return _internal_id();
}
inline void RegisterRequeset::_internal_set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  id_ = value;
}
inline void RegisterRequeset::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_id(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterRequeset.id)
}

// bytes name = 2;
inline void RegisterRequeset::clear_name() {
  name_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& RegisterRequeset::name() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterRequeset.name)
  return _internal_name();
}
inline void RegisterRequeset::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterRequeset.name)
}
inline std::string* RegisterRequeset::mutable_name() {
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterRequeset.name)
  return _internal_mutable_name();
}
inline const std::string& RegisterRequeset::_internal_name() const {
  return name_.Get();
}
inline void RegisterRequeset::_internal_set_name(const std::string& value) {
  
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void RegisterRequeset::set_name(std::string&& value) {
  
  name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RegisterRequeset.name)
}
inline void RegisterRequeset::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:fixbug.RegisterRequeset.name)
}
inline void RegisterRequeset::set_name(const void* value,
    size_t size) {
  
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:fixbug.RegisterRequeset.name)
}
inline std::string* RegisterRequeset::_internal_mutable_name() {
  
  return name_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* RegisterRequeset::release_name() {
  // @@protoc_insertion_point(field_release:fixbug.RegisterRequeset.name)
  return name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void RegisterRequeset::set_allocated_name(std::string* name) {
  if (name != nullptr) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegisterRequeset.name)
}
inline std::string* RegisterRequeset::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:fixbug.RegisterRequeset.name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RegisterRequeset::unsafe_arena_set_allocated_name(
    std::string* name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (name != nullptr) {
  ...
  name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.RegisterRequeset.name)
}

// bytes pwd = 3;
inline void RegisterRequeset::clear_pwd() {
  pwd_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& RegisterRequeset::pwd() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterRequeset.pwd)
  return _internal_pwd();
}
inline void RegisterRequeset::set_pwd(const std::string& value) {
  _internal_set_pwd(value);
  // @@protoc_insertion_point(field_set:fixbug.RegisterRequeset.pwd)
}
inline std::string* RegisterRequeset::mutable_pwd() {
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterRequeset.pwd)
  return _internal_mutable_pwd();
}
inline const std::string& RegisterRequeset::_internal_pwd() const {
  return pwd_.Get();
}
inline void RegisterRequeset::_internal_set_pwd(const std::string& value) {
  
  pwd_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void RegisterRequeset::set_pwd(std::string&& value) {
  
  pwd_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:fixbug.RegisterRequeset.pwd)
}
inline void RegisterRequeset::set_pwd(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pwd_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:fixbug.RegisterRequeset.pwd)
}
inline void RegisterRequeset::set_pwd(const void* value,
    size_t size) {
  
  pwd_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:fixbug.RegisterRequeset.pwd)
}
inline std::string* RegisterRequeset::_internal_mutable_pwd() {
  
  return pwd_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* RegisterRequeset::release_pwd() {
  // @@protoc_insertion_point(field_release:fixbug.RegisterRequeset.pwd)
  return pwd_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void RegisterRequeset::set_allocated_pwd(std::string* pwd) {
  if (pwd != nullptr) {
  ...
  pwd_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pwd,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:fixbug.RegisterRequeset.pwd)
}
inline std::string* RegisterRequeset::unsafe_arena_release_pwd() {
  // @@protoc_insertion_point(field_unsafe_arena_release:fixbug.RegisterRequeset.pwd)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return pwd_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void RegisterRequeset::unsafe_arena_set_allocated_pwd(
    std::string* pwd) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (pwd != nullptr) {
  ...
  pwd_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      pwd, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.RegisterRequeset.pwd)
}
