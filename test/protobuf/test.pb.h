...
class ResultCode PROTOBUF_FINAL :
 ...
 public:
  ...
  // int32 errcoed = 1;
  void clear_errcoed();
  ::PROTOBUF_NAMESPACE_ID::int32 errcoed() const;
  void set_errcoed(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_errcoed() const;
  void _internal_set_errcoed(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 errcoed_;
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ResultCode::_internal_errcoed() const {
  return errcoed_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ResultCode::errcoed() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.errcoed)
  return _internal_errcoed();
}
inline void ResultCode::_internal_set_errcoed(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  errcoed_ = value;
}
inline void ResultCode::set_errcoed(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_errcoed(value);
  // @@protoc_insertion_point(field_set:fixbug.ResultCode.errcoed)
}
